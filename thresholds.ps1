...
# ---------------------------------------------
$konaMax = @{
    "16415600" = @{ Kona1 = 12.3; Kona2 = 13.4 }
    "16400000" = @{ Kona1 = 9.3; Kona2 = 9.2 }
    "16638500" = @{ Kona1 = 3.5; Kona2 = 3.2 }
    "16620000" = @{ Kona1 = 6.1;  Kona2 = 5.8 }
    "16618000" = @{ Kona1 = 5.3;  Kona2 = 5.7 }
    "16614000" = @{ Kona1 = 6.7; Kona2 = 5.6 }
    "16604500" = @{ Kona1 = 8.3;  Kona2 = 4.0 }
    "16605500" = @{ Kona1 = 13.4; Kona2 = 13.5 } 
    "16587000" = @{ Kona1 = 2.5;  Kona2 = 3.1 }
    "16552800" = @{ Kona1 = 6.5;  Kona2 = 3.0 }
    "16518000" = @{ Kona1 = 9.0; Kona2 = 11.8 }
    "16508000" = @{ Kona1 = 8.8;  Kona2 = 7.8 }
    "16501200" = @{ Kona1 = 9.4;  Kona2 = 6.4 }
    "16641000" = @{ Kona1 = 15.2;  Kona2 = $null }
    "16527000" = @{ Kona1 = 8.2;  Kona2 = 9.8 }
    "16647900" = @{ Kona1 = 6.5;  Kona2 = 5.7 }
    "16415000" = @{ Kona1 = 6.4;  Kona2 = 6.6 }
    "16611500" = @{ Kona1 = 6.1;  Kona2 = 5.4 }
    "16414200" = @{ Kona1 = 5.8;  Kona2 = 9.3 }
    "16545000" = @{ Kona1 = 5.4;  Kona2 = 7.4 }
    "16570000" = @{ Kona1 = 4.8;  Kona2 = 6.8 }
    "16536000" = @{ Kona1 = 4.0;  Kona2 = 5.2 }
    "16623300" = @{ Kona1 = 1.7;  Kona2 = 1.7 }
    "16647000" = @{ Kona1 = 11.7;  Kona2 = $null }
}
