...
$konaMax = @{
    ...
    # "16620000" = @{ Kona1 = 0.0;  Kona2 = 0.0 }
    # "16618000" = @{ Kona1 = 0.0;  Kona2 = 0.0 }
    # "16614000" = @{ Kona1 = 0.0; Kona2 = 0.0 }
    # "16604500" = @{ Kona1 = 0.0;  Kona2 = 0.0 }
    # "16605500" = @{ Kona1 = 13.4; Kona2 = 13.5 } 
    # "16587000" = @{ Kona1 = 0.0;  Kona2 = 0.0 }
    # "16552800" = @{ Kona1 = 0.0;  Kona2 = 0.0 }
    # "16518000" = @{ Kona1 = 0.0; Kona2 = 0.0 }
    # "16508000" = @{ Kona1 = 0.0;  Kona2 = 0.0 }
    # "16501200" = @{ Kona1 = 0.0;  Kona2 = 0.0 }
}
